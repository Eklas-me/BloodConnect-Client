        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 text-white font-bold text-xl mb-4">
              <Droplets className="h-6 w-6 text-primary fill-primary" />
              BloodConnect
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed">
              Connecting blood donors with those in need. Every drop counts in saving a life.
            </p>
            {/* Social links */}
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"].map((bg) => (
                <span
                  key={bg}
                  className="text-xs font-bold bg-primary/20 text-primary rounded px-2 py-1 text-center"
                >
                  {bg}
                </span>
              ))}
            ...
            <p className="text-xs text-gray-400 mt-3">
              All blood types accepted. Register today to save lives.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-gray-400">
                ...
                <span>123 Health Plaza, Dhaka 1205, Bangladesh</span>
              </li>
